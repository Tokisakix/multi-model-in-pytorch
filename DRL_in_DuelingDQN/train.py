...
from framework import DuelingDQN
...
def test(env_name : str, agent : DuelingDQN):
...
def train(env_name : str, replay_buffer : ReplayBuffer, agent : DuelingDQN, epochs : int):
...
if __name__ == "__main__":
    ...
    agent         = DuelingDQN(q_net, target_q_net, 2, LEARNING_RATE, GAMMA, EPSILON, TARGET_UPDATE, CUDA)
